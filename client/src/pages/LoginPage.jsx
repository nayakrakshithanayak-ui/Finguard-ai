  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-slate-900 to-black text-white">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        >
          <h1 className="text-2xl font-bold text-white">Login to FinGuard AI</h1>
          <p className="mt-1 text-sm text-slate-300">Track your spending and stay in control.</p>
          ...
          <p className="mt-4 text-sm text-slate-300">
            New user?{" "}
            <Link to="/register" className="font-semibold text-indigo-300 transition-all duration-300 hover:text-indigo-200">
              Create an account
            </Link>
          </p>
        </form>
